<template>
  <div class="flex justify-center h-full items-center" style="height:100vh">
    <div class="w-full px-6" style="max-width:340px">
      ...
      >
        ...
        <div class="flex justify-center mt-4">
          <p class="text-sm">
            ...
            <span @click="toggle" class=" font-bold text-blue-500">
      ...
      <p class="text-center text-gray-500 text-xs">
        &copy; {{ year }} Michal Muller. All rights reserved.
      </p>
    </div>
  </div>
</template>
